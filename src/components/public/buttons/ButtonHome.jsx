...
const showButtons = button.map((button,i) =>{ //vai renderizar o array dos botões
  ...
  return(
      ...
      key={i}
      href={`${button.link}`}
      target={modLinkOpen(button.link) ? "_self" : "_blank"} /*Vai terminar se o link vai ser aberto na aba atual ou em uma nova aba*/
      //rel={modLinkOpen(button.link) ? "" : "noreferrer"}
      rel="noreferrer"
